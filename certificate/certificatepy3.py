...
cliques = df_bounded_non_homogeneous_100['clique'].unique()
cliques = cliques[7:]
...
for clique in tqdm(cliques, desc='Procesando clique', unit='clique'):
    ...
    df = df_bounded_non_homogeneous_100[df_bounded_non_homogeneous_100['clique'] == clique].copy()
    ...
    joblib.dump(df_concatenado, 'dataframes_min/df_bounded_non_homogeneous_100_2.pkl')
