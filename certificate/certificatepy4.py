...
cliques = df_bounded_non_homogeneous_1000['clique'].unique()
cliques = cliques[11:]
dfclique_list = []
...
for clique in tqdm(cliques, desc='Procesando clique', unit='clique'):
    ...
    df = df_bounded_non_homogeneous_1000[df_bounded_non_homogeneous_1000['clique'] == clique].copy()
    ...
    joblib.dump(df_concatenado, 'dataframes_min/df_bounded_non_homogeneous_1000_2.pkl')
